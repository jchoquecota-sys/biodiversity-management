...
echo "\n=== BUSCANDO FOTOGRAFÍAS REALES VERIFICADAS ===\n\n";

// PASO 1: Limpiar URLs no funcionales
echo "PASO 1: Limpiando URLs no funcionales...\n";
$clearSql = "UPDATE biodiversity_categories SET 
                ...
                updated_at = NOW()";
$pdo->exec($clearSql);
echo "✓ URLs no funcionales eliminadas\n\n";

// PASO 2: URLs reales verificadas de especies peruanas
echo "PASO 2: Agregando fotografías reales verificadas...\n";

// URLs reales verificadas de Wikimedia Commons
$verifiedRealPhotos = [
    // MAMÍFEROS PERUANOS
    'Vicugna vicugna' => [
...
echo "Procesando " . count($verifiedRealPhotos) . " especies con fotografías reales verificadas...\n\n";

foreach ($verifiedRealPhotos as $scientificName => $images) {
...
echo "¡Actualización con fotografías reales verificadas completada!\n";
echo "Fuente: Wikimedia Commons (fotografías científicas verificadas)\n";
