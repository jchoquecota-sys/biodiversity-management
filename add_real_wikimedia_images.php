...
echo "\n=== AGREGANDO IMÁGENES REALES DE WIKIMEDIA COMMONS ===\n\n";
...
echo "Procesando " . count($realWikimediaImages) . " especies con URLs reales y verificadas...\n\n";

foreach ($realWikimediaImages as $scientificName => $photos) {
