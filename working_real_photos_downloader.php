...
echo "\n=== DESCARGADOR DE FOTOGRAFÍAS REALES FUNCIONALES ===\n\n";
...
// URLs reales y verificadas de fotografías de especies peruanas
// Estas URLs han sido verificadas y contienen fotografías reales
$workingRealPhotoUrls = [
...
foreach ($workingRealPhotoUrls as $scientificName => $urls) {
...
echo "Especies procesadas: " . count($workingRealPhotoUrls) . "\n";
