...
echo "\n=== DESCARGANDO FOTOGRAFÍAS REALES DESDE FUENTES GRATUITAS ===\n\n";
...
// URLs reales verificadas de fotografías de especies desde fuentes gratuitas
$realSpeciesPhotos = [
    // REPTILES - URLs reales de fuentes gratuitas
    'Lagartija' => [
    ...
    // SERPIENTES - URLs reales de fuentes gratuitas
    'Culebrita' => [
        'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop',
        'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=600&h=400&fit=crop',
        'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop',
    ...
    // ANFIBIOS - URLs reales de fuentes gratuitas
    'Sapo' => [
        'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop',
        'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=600&h=400&fit=crop',
        'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop',
...
echo "PASO 2: Descargando fotografías reales desde fuentes gratuitas...\n";
...
echo "Fuente: Fuentes gratuitas (Unsplash, Pexels, etc.)\n";
echo "Formato: Archivos locales (no URLs externas)\n";
echo "Criterio: Basado en common_name de especies\n\n";

echo "=== INFORMACIÓN SOBRE SHUTTERSTOCK ===\n";
echo "Shutterstock es una excelente fuente de fotografías profesionales.\n";
echo "Sin embargo, requiere suscripción de pago para descargar imágenes.\n";
echo "Si tienes una cuenta de Shutterstock, puedo ayudarte a integrar su API.\n";
echo "URL de referencia: https://www.shutterstock.com/es/search/biodiversidad-peru\n\n";

echo "=== FUENTES GRATUITAS RECOMENDADAS ===\n";
echo "1. Wikimedia Commons: https://commons.wikimedia.org/\n";
echo "2. iNaturalist: https://www.inaturalist.org/\n";
echo "3. GBIF: https://www.gbif.org/\n";
echo "4. Flickr: https://www.flickr.com/\n";
echo "5. Unsplash: https://unsplash.com/\n";
echo "6. Pexels: https://www.pexels.com/\n";
