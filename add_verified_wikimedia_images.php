...
echo "Procesando " . count($verifiedWikimediaImages) . " especies con URLs reales y verificadas...\n\n";

foreach ($verifiedWikimediaImages as $scientificName => $photos) {
