...
echo "\n=== LIMPIANDO IMÁGENES SINTÉTICAS Y BUSCANDO FOTOGRAFÍAS REALES ===\n\n";

// PASO 1: Limpiar todas las imágenes sintéticas
echo "PASO 1: Limpiando todas las imágenes sintéticas...\n";
$clearSql = "UPDATE biodiversity_categories SET 
                ...
                updated_at = NOW()";
$pdo->exec($clearSql);
echo "✓ Todas las imágenes sintéticas han sido eliminadas\n\n";
