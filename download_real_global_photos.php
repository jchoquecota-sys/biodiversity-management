...
echo "\n=== DESCARGANDO FOTOGRAFÍAS REALES DE ESPECIES SIMILARES DE TODO EL MUNDO ===\n\n";
...
// URLs reales verificadas de fotografías de especies similares de todo el mundo
$globalSpeciesPhotos = [
    // REPTILES - URLs reales de Wikimedia Commons
    'Lagartija' => [
    ...
    // SERPIENTES - URLs reales de Wikimedia Commons
    'Culebrita' => [
    ...
    // ANFIBIOS - URLs reales de Wikimedia Commons
    'Sapo' => [
...
echo "PASO 2: Descargando fotografías de especies similares de todo el mundo...\n";
echo "Procesando " . count($globalSpeciesPhotos) . " tipos de especies...\n\n";

$totalDownloaded = 0;
$totalFailed = 0;
$speciesUpdated = 0;

foreach ($globalSpeciesPhotos as $commonName => $imageUrls) {
    ...
    foreach ($species as $specie) {
        ...
        foreach ($imageUrls as $imageUrl) {
            $imageCount++;
            $filename = "{$globalImagesDir}/species_{$specie['id']}_{$imageCount}.jpg";
            ...
            if ($result['success']) {
                ...
                $downloadedImages[] = "images/global_species/species_{$specie['id']}_{$imageCount}.jpg";
                $totalDownloaded++;
            } else {
...
// Mostrar resumen
echo "=== RESUMEN DE DESCARGA DE FOTOGRAFÍAS GLOBALES ===\n";
echo "Tipos de especies procesados: " . count($globalSpeciesPhotos) . "\n";
...
echo "=== EJEMPLOS DE FOTOGRAFÍAS GLOBALES DESCARGADAS ===\n";
...
echo "¡Descarga de fotografías globales completada!\n";
echo "Directorio: $globalImagesDir\n";
echo "Tipo: Fotografías de especies similares/afines de todo el mundo\n";
echo "Fuente: Internet internacional (Wikimedia Commons, sitios científicos)\n";
