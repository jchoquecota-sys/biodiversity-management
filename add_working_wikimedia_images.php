...
echo "\n=== AGREGANDO IMÁGENES FUNCIONALES DE WIKIMEDIA COMMONS ===\n\n";
...
echo "Procesando " . count($workingWikimediaImages) . " especies con URLs reales y verificadas...\n\n";

foreach ($workingWikimediaImages as $scientificName => $photos) {
