...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [            'text' => 'Dashboard',            'url' => 'admin',            'icon' => 'fas fa-fw fa-tachometer-alt'        ],
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'url' => 'admin/biodiversity',
                    'icon' => 'fas fa-fw fa-list'
                ],
                [
                    'text' => 'Estados de Conservación',
                    'url' => 'admin/conservation-status',
                    'icon' => 'fas fa-fw fa-shield-alt'
                ],
                [
                    'text' => 'Papelera',
                    'url' => 'admin/biodiversity/trashed',
                    'icon' => 'fas fa-fw fa-trash'
                ],
                [
                    'text' => 'Exportar Datos',
                    'url' => 'admin/biodiversity/export',
        ...
        [
            'text' => 'Reporte de Biodiversidad',
            'url' => 'admin/reports/biodiversity',
            'icon' => 'fas fa-fw fa-chart-pie'
        ],
        [
            'text' => 'Reporte de Publicaciones',
            'url' => 'admin/reports/publications',
