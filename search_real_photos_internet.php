...
echo "\n=== BUSCANDO FOTOGRAFÍAS REALES EN INTERNET INTERNACIONAL ===\n\n";

// Crear directorio para imágenes reales
$realImagesDir = 'public/images/real_photos';
...
// URLs reales verificadas de fotografías de especies peruanas desde sitios web internacionales
$realSpeciesPhotos = [
    // MAMÍFEROS PERUANOS - URLs reales de Wikimedia Commons
    'Vicuña' => [
        'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Vicugna_vicugna_1_fcm.jpg/800px-Vicugna_vicugna_1_fcm.jpg',
        'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Vicuna_Vicugna_vicugna.jpg/600px-Vicuna_Vicugna_vicugna.jpg',
        'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Vicugna_vicugna_2_fcm.jpg/800px-Vicugna_vicugna_2_fcm.jpg',
    ...
    // ESPECIES MARINAS PERUANAS - URLs reales de Wikimedia Commons
    'Lobo Marino' => [
...
echo "PASO 2: Descargando fotografías reales desde internet internacional...\n";
...
foreach ($realSpeciesPhotos as $commonName => $imageUrls) {
    // Buscar la especie en la base de datos por nombre común
    ...
    if (!$specie) {
        echo "- Especie no encontrada: {$commonName}\n";
        continue;
    }
    ...
    foreach ($imageUrls as $imageUrl) {
        ...
        if ($result['success']) {
            ...
            $downloadedImages[] = "images/real_photos/species_{$specie['id']}_{$imageCount}.jpg";
            $totalDownloaded++;
        } else {
